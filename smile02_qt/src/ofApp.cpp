...
void ofApp::draw(){
    ...
    if(loopflag == 1){
       if(flag == 1){
        ...
        if(countFlag == 0){
            font.drawString("5", 10, 100);
        }else if(countFlag == 1){
            font.drawString("4", 10, 100);
        }else if(countFlag == 2){
            font.drawString("3", 10, 100);
        }else if(countFlag == 3){
            font.drawString("2", 10, 100);
        }else if(countFlag == 4){
            font.drawString("1", 10, 100);
            loopflag =2;
        }else if(countFlag == 5){
            smileStartTime = ofGetSeconds();
        }
    ...
    if(countFlag == 5){b_push.draw((1280 - 729*1.5)/2, 30, 729*1.5, 516*1.5);
}
